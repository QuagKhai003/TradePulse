...
**Last updated:** 2026-07-14 (buyers/sellers/past orders; 659-product tender coverage; data current to 2025)
...
- **Buyers** = open EU TED tenders. **Sellers** = organisations that WON a public contract (ADR-0005 —
  sellers never advertise, so a seller list must be derived, not collected). **Past orders** = the award
  notices themselves, both sides named. Live: 6,006 open tenders, 641 products with sellers + past
  orders, 8,111 sellers.

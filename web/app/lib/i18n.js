...
const STRINGS = {
  vi: {
    ...
    period: "Kỳ",
    published: "công bố",
    feedTitle: "Khối lượng giao dịch",
    ...
    topCountries: "Quốc gia xuất nhập khẩu hàng đầu", allCountries: "quốc gia",
    ...
    sort: "Sắp xếp", sortSignal: "Tín hiệu", sortChange: "% thay đổi", sortValue: "Giá trị", sortName: "Tên",
  ...
  en: {
    ...
    topCountries: "top countries", allCountries: "countries",
    mapTitle: "Signal map",
    clickCountry: "Click a country to drill in",
    login: "Log in", signup: "Sign up",
    browseCountries: "Search country", dataUpdated: "Updated",
    sort: "Sort", sortSignal: "Signal", sortChange: "% change", sortValue: "Value", sortName: "Name",
